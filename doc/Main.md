...
Description of all documentation files and links for them 

for read documentation you need a markdown reader like the obsidian or MarkText
you can also use github project page for read the documentation 

## init

File that nvim identify as starting point and load all configurations and plugins
...
Contains my custom comands and this is file for you write your custom commands 
if necessary or according to your needs 

- **[Commands documentation](files/commands.md)** <br>
- **[Commands lua file](../lua/commands.lua)**
...
This file contains the base configuration for nvim and some plugins for example you need modify 
...
Contains all plugins used on this project with packer function for detect plugins on 
...
File for plugins configuration setup for basic config of all plugins and custon plugins config 
